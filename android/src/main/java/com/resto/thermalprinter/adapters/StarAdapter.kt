...
class StarAdapter(private val context: Context) : PrinterAdapter {
    ...
    private fun mapItem(pb: PrinterBuilder, item: com.resto.thermalprinter.model.PrintItem, profile: PrinterProfile) {
        when (item) {
            ...
            is com.resto.thermalprinter.model.PrintItem.Feed -> pb.actionFeedLine(item.lines.coerceAtLeast(1))
